...
namespace AssessmentApplication.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(bartolomeZambranaPerezDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,FirstName,LastName,DriverLicense")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'bartolomeZambranaPerezDatabaseContext.Owners'  is null.");
            }
            var owner = await _context.Owners.FindAsync(id);
            if (owner != null)
            {
