...
namespace AssessmentApplication.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(bartolomeZambranaPerezDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var bartolomeZambranaPerezDatabaseContext = _context.Vehicles.Include(v => v.Owner);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Brand,Vin,Color,Year,OwnerId")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'bartolomeZambranaPerezDatabaseContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
